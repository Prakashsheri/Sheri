...
public class GivenProtocolBill {


	public static void GivenBill (WebDriver driver) throws InterruptedException, IOException {
		...
		Thread.sleep(1000);
		aa.moveToElement(driver.findElement(By.xpath("//a[.='Create Bill (Given Protocol)']"))).click().perform();
		Thread.sleep(1000); 
		...
		org.apache.poi.ss.usermodel.Sheet sheet = wb.getSheet("GivenProtocolBills");
		...
		for (int i = startIndex; i >= firstRow  && i <=lastRow ; i++) 
		{
			...
			driver.findElement(By.xpath("//button[@class='alertify-button alertify-button-ok']")).click();
			Thread.sleep(1000);
