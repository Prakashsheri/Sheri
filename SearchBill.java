...
public class SearchBill {
	public static void Searchbills(WebDriver driver) throws InterruptedException, IOException {
		...
		aa.moveToElement(driver.findElement(By.xpath("//a[.='Search Bills']"))).click().perform();
		...
		for (int i = startIndex; i >= firstRow  && i <=lastRow ; i++) 
		{
			...
			driver.findElement(By.xpath("//button[@id='viewPrintBill']")).click();
			Thread.sleep(3000);
